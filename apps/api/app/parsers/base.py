...
class MarketplaceParser:
    ...
    def normalize_row(self, row: dict[str, Any], source_file: str) -> dict:
        ...
        txn = {
            ...
            "order_id": text(first_value(row, ["order_id", "order id", "amazon order id", "order no", "sub order num", "suborder no", "suborder number"])),
            "order_item_id": text(first_value(row, ["order_item_id", "order item id", "order item identifier", "item id", "sub order num", "suborder no", "suborder number"])),
            ...
            "taxable_value": money(first_value(row, ["taxable_value", "taxable value", "taxable amount", "tax exclusive gross", "taxable sales", "price before tax", "taxable turnover", "total taxable sale value"])),
            "gst_rate": money(first_value(row, ["gst_rate", "gst rate", "tax rate", "igst rate", "total tax rate"])),
            "igst": money(first_value(row, ["igst tax", "igst amount", "integrated tax", "igst", "tax amount", "total tax amount", "gst amount"])),
            ...
            "gross_amount": money(first_value(row, ["gross_amount", "gross amount", "invoice amount", "total amount", "selling price", "price before discount", "total invoice value"])),
